...
public class API extends PlaceholderExpansion {
  ...
  public String onRequest(OfflinePlayer player, String check) {
    ...
    if (player == null) {
      ...
      if (check.contains("World_TrustList_")) {
        ...
        if (Variable.bungee) {
          ...
          File f = new File(Variable.Tempf, String.valueOf(String.valueOf(temp)) + ".yml");
      ...
      if (check.contains("World_Type_")) {
        ...
        if (Bukkit.getWorld(String.valueOf(String.valueOf(Variable.world_prefix)) + temp) != null) {
          World world = Bukkit.getWorld(String.valueOf(String.valueOf(Variable.world_prefix)) + temp);
    ...
    if (check.equalsIgnoreCase("Tile")) {
      World world = Bukkit.getWorld(String.valueOf(String.valueOf(Variable.world_prefix)) + player.getPlayer().getName());
      if (world == null) {
        result_check = Variable.Lang_YML.getString("PlaceHolders.Error");
        return result_check;
      } 
    ...
    if (check.equalsIgnoreCase("World_Tile")) {
      World world = Bukkit.getWorld(
          String.valueOf(String.valueOf(Variable.world_prefix)) + player.getPlayer().getWorld().getName().replace(Variable.world_prefix, ""));
      if (world == null) {
        result_check = Variable.Lang_YML.getString("PlaceHolders.Error");
        return result_check;
      } 
    ...
    if (check.equalsIgnoreCase("World_Level")) {
      ...
      if (Variable.bungee) {
        ...
        File f = new File(Variable.Tempf, 
            String.valueOf(String.valueOf(player.getPlayer().getWorld().getName().replace(Variable.world_prefix, ""))) + ".yml");
        YamlConfiguration yml = YamlConfiguration.loadConfiguration(f);
        result_check = String.valueOf(yml.getInt("Level"));
      } 
    } 
    if (check.equalsIgnoreCase("Level")) {
      ...
      if (Variable.bungee) {
        ...
        File f = new File(Variable.Tempf, String.valueOf(String.valueOf(player.getPlayer().getName())) + ".yml");
        YamlConfiguration yml = YamlConfiguration.loadConfiguration(f);
        result_check = String.valueOf(yml.getInt("Level"));
      } 
    } 
    ...
    if (check.toUpperCase().contains("LEVELTOP_")) {
      ...
      if (Variable.bungee) {
        ...
        File folder = new File(Variable.Tempf);
        List<com.PlaceHolder.Home> homelist = new ArrayList<>();
        File[] arrayOfFile;
        for (int k = (arrayOfFile = folder.listFiles()).length, b = 0; b < k; ) {
          File temp = arrayOfFile[b];
