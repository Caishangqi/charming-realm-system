...
import com.GUI.ManageGui4;
import com.GUI.ManageGui5;
  ...
  public boolean onCommand(final CommandSender sender, Command cmd, String Label, final String[] args) {
      ...
      if (sender instanceof Player) {
        ...
        if (args.length == 4 && 
          ...
          if (Variable.bungee) {
            ...
            File f2 = new File(Variable.Tempf, String.valueOf(String.valueOf(args[2])) + ".yml");
          ...
          FirstBorderShaped.AddShapeBorder(Bukkit.getWorld(String.valueOf(Variable.world_prefix) + args[2]));
        ...
        if (args.length == 2 && 
          ...
          if (Main.JavaPlugin.getConfig().getBoolean("AutoReCreateInLowerLagHome") && !Variable.wait_to_command.containsKey(player.getName()) && Main.JavaPlugin.getConfig().getBoolean("BungeeCord")) {
            if (Main.JavaPlugin.getConfig().getString("DecideBy").equalsIgnoreCase("Player")) {
              if (!MySQL.getLowerstLagServer().equalsIgnoreCase(Main.JavaPlugin.getConfig().getString("Server"))) {
                ...
                player.sendMessage(Variable.Lang_YML.getString("StartLowestLagServer"));
    ...
    if (args.length == 3 && 
      ...
      if (Variable.world_prefix.equalsIgnoreCase("")) {
        if (Bukkit.getVersion().toString().toUpperCase().contains("ARCLIGHT")) {
          newf = new File(String.valueOf(Variable.single_server_gen) + Variable.world_prefix + Variable.file_loc_prefix + args[2]);
        } else {
          newf = new File(String.valueOf(Variable.single_server_gen) + "world" + Variable.file_loc_prefix + args[2]);
        } 
      } else {
        newf = new File(String.valueOf(Variable.single_server_gen) + Variable.world_prefix + Variable.file_loc_prefix + args[2]);
      } 
      ...
      Variable.create_list_home.add(String.valueOf(Variable.world_prefix) + args[2]);
      ...
      if (sender instanceof Player) {
        ...
        player.sendMessage(Variable.Lang_YML.getString("WorldTeleport"));
      } 
      return false;
    } 
    if (args.length == 3 && 
    ...
    if (args.length == 2 && 
      ...
      for (String key : yamlConfiguration3.getKeys(true)) {
        ...
        if (Variable.world_prefix.equalsIgnoreCase("")) {
          if (Bukkit.getVersion().toString().toUpperCase().contains("ARCLIGHT")) {
            oldf = new File(String.valueOf(Variable.single_server_gen) + "PlayerWorldsPro" + Variable.file_loc_prefix);
          } else {
            oldf = new File(String.valueOf(Variable.single_server_gen) + "world" + Variable.file_loc_prefix);
          } 
        } else {
          oldf = new File(String.valueOf(Variable.single_server_gen) + "PlayerWorldsPro" + Variable.file_loc_prefix);
        } 
        if (Variable.world_prefix.equalsIgnoreCase("")) {
          if (Bukkit.getVersion().toString().toUpperCase().contains("ARCLIGHT")) {
            newf = new File(String.valueOf(Variable.single_server_gen) + Variable.world_prefix);
          } else {
            newf = new File(String.valueOf(Variable.single_server_gen) + "world" + Variable.file_loc_prefix);
          } 
        } else {
          newf = new File(String.valueOf(Variable.single_server_gen) + Variable.world_prefix);
        } 
        File oldFile = new File(String.valueOf(String.valueOf(oldf.getPath().toString())) + Variable.file_loc_prefix + prefix + uuid);
        System.out.println(oldFile.getPath());
        File newFile = new File(String.valueOf(String.valueOf(newf.getPath().toString())) + Variable.file_loc_prefix + name);
    ...
    if (args.length == 2 && 
      ...
      World world = Bukkit.getWorld(String.valueOf(Variable.world_prefix) + args[1]);
      if (world != null) {
        for (Player p6 : Bukkit.getWorld(String.valueOf(Variable.world_prefix) + args[1]).getPlayers()) {
          p6.teleport(Bukkit.getWorld("world").getSpawnLocation());
          p6.sendMessage(Variable.Lang_YML.getString("WorldHasBeenForceDelete"));
        } 
        Bukkit.unloadWorld(String.valueOf(Variable.world_prefix) + args[1], true);
        sender.sendMessage(Variable.Lang_YML.getString("WorldHasBeenForceDeleteSuccess"));
      } 
      if (Variable.hook_multiverseCore) {
        MultiverseCore mvcore = (MultiverseCore)Bukkit.getServer().getPluginManager().getPlugin("Multiverse-Core");
        MVWorldManager mv_m = mvcore.getMVWorldManager();
        mv_m.removeWorldFromConfig(String.valueOf(Variable.world_prefix) + args[1]);
      } 
      ...
      if (Variable.world_prefix.equalsIgnoreCase("")) {
        if (Bukkit.getVersion().toString().toUpperCase().contains("ARCLIGHT") || Bukkit.getVersion().toString().contains("1.20.1")) {
          f = new File(String.valueOf(Variable.single_server_gen) + Variable.world_prefix + args[1]);
        } else {
          f = new File(String.valueOf(Variable.single_server_gen) + "world" + Variable.file_loc_prefix + args[1]);
        } 
      } else {
        f = new File(String.valueOf(Variable.single_server_gen) + Variable.world_prefix + args[1]);
      } 
      ...
      if (Variable.bungee) {
        ...
        File f2 = new File(Variable.Tempf, String.valueOf(String.valueOf(args[1])) + ".yml");
        if (f2.exists()) {
          sender.sendMessage(Variable.Lang_YML.getString("WorldConfigHasBeenDeleted"));
          f2.delete();
        } 
    ...
    if (args.length == 4) {
      ...
      if (args[0].equalsIgnoreCase("admin") && args[1].equalsIgnoreCase("create")) {
        if (Main.JavaPlugin.getConfig().getBoolean("BungeeCord")) {
          ...
          File f2 = new File(Variable.Tempf, String.valueOf(String.valueOf(args[2].replace(Variable.world_prefix, ""))) + ".yml");
          if (f2.exists()) {
            sender.sendMessage(Variable.Lang_YML.getString("HeadLineTtitle"));
        ...
        if (v.equalsIgnoreCase("1")) {
          ...
          WorldCreator creator = null;
          creator = new WorldCreator(String.valueOf(Variable.world_prefix) + args[2]);
          Main.JavaPlugin.getDefaultWorldGenerator(String.valueOf(Variable.world_prefix) + args[2], "");
          if (Main.JavaPlugin.getConfig().getBoolean("generateStructures")) {
            creator = creator.generateStructures(true);
          } else {
            creator = creator.generateStructures(false);
          ...
          String oldDir = String.valueOf(String.valueOf(Variable.worldFinal)) + v;
          String newDir = "";
          if (Variable.world_prefix.equalsIgnoreCase("")) {
            if (Bukkit.getVersion().toString().toUpperCase().contains("ARCLIGHT") || Bukkit.getVersion().toString().contains("1.20.1")) {
              newDir = String.valueOf(Variable.single_server_gen) + Variable.world_prefix + args[2];
            } else {
              newDir = String.valueOf(Variable.single_server_gen) + "world" + Variable.file_loc_prefix + args[2];
            } 
          } else {
            newDir = String.valueOf(Variable.single_server_gen) + Variable.world_prefix + args[2];
          } 
        ...
        if (Variable.hook_multiverseCore) {
          ...
          MultiverseCore mvcore = (MultiverseCore)Bukkit.getServer().getPluginManager().getPlugin("Multiverse-Core");
          MVWorldManager mv_m = mvcore.getMVWorldManager();
          if (mv_m.isMVWorld(String.valueOf(Variable.world_prefix) + args[2]))
            mv_m.removeWorldFromConfig(String.valueOf(Variable.world_prefix) + args[2]); 
          if (v.equalsIgnoreCase("1")) {
            mv_m.addWorld(String.valueOf(Variable.world_prefix) + args[2], World.Environment.NORMAL, seed, WorldType.NORMAL, Boolean.valueOf(Main.JavaPlugin.getConfig().getBoolean("generateStructures")), "");
          } else if (v.equalsIgnoreCase("2")) {
            mv_m.addWorld(String.valueOf(Variable.world_prefix) + args[2], World.Environment.NORMAL, seed, WorldType.FLAT, Boolean.valueOf(Main.JavaPlugin.getConfig().getBoolean("generateStructures")), "");
          } else {
            mv_m.addWorld(String.valueOf(Variable.world_prefix) + args[2], World.Environment.NORMAL, seed, WorldType.NORMAL, Boolean.valueOf(Main.JavaPlugin.getConfig().getBoolean("generateStructures")), "");
          } 
          if (Main.JavaPlugin.getConfig().getBoolean("EnableChatPrefix")) {
            MultiverseWorld multiverseWorld = mv_m.getMVWorld(String.valueOf(Variable.world_prefix) + args[2]);
            World world1 = Bukkit.getWorld(String.valueOf(Variable.world_prefix) + args[2]);
            String temp = Variable.Lang_YML.getString("PlaceHolders.WorldName");
            if (temp.contains("<PlayerName>"))
              temp = temp.replace("<PlayerName>", 
                  world1.getName().replace(Variable.world_prefix, "")); 
            if (temp.contains("<WorldName>"))
              temp = temp.replace("<WorldName>", 
                  world1.getName().replace(Variable.world_prefix, "")); 
            multiverseWorld.setAlias(temp);
          } 
          MultiverseWorld mv = mv_m.getMVWorld(String.valueOf(Variable.world_prefix) + args[2]);
          mv.setAutoLoad(false);
        } 
        World world = Bukkit.getWorld(String.valueOf(Variable.world_prefix) + args[2]);
        if (Variable.bungee) {
        ...
        if (Main.JavaPlugin.getConfig().getBoolean("BorderSwitch"))
          try {
            World world = Bukkit.getWorld(
                String.valueOf(Variable.world_prefix) + p.getWorld().getName().replace(Variable.world_prefix, ""));
        ...
        if (player.hasPermission("SelfHome.Biome")) {
          ...
          try {
            ...
            for (Player onlinePlayer : world.getPlayers())
              onlinePlayer.sendMessage(Variable.Lang_YML.getString("BiomeChangeTip")); 
            String successMessage = String.format(Variable.Lang_YML.getString("BiomeChangeSuccess"), new Object[] { biome.name() });
            player.sendMessage(successMessage);
          } catch (IllegalArgumentException e) {
            player.sendMessage(Variable.Lang_YML.getString("BiomeError"));
            return false;
          } 
        } else {
          String noPermissionMessage = Variable.Lang_YML.getString("NoPermissionCheck");
          if (noPermissionMessage.contains("<Permission>"))
            noPermissionMessage = noPermissionMessage.replace("<Permission>", "SelfHome.Biome"); 
          player.sendMessage(Variable.Lang_YML.getString("HeadLineTtitle"));
          player.sendMessage(noPermissionMessage);
          player.sendMessage(Variable.Lang_YML.getString("BottomLineTtitle"));
          return false;
        } 
      } 
      return false;
    ...
    if (args.length == 2 && args[0].equalsIgnoreCase("setWorldBiome")) {
      if (sender instanceof Player) {
        ...
        if (player.hasPermission("SelfHome.WorldBiome")) {
          ...
          try {
            final Biome biome = Biome.valueOf(args[1].toUpperCase());
            player.sendMessage(Variable.Lang_YML.getString("BiomeChangeStart"));
            (new BukkitRunnable() {
                public void run() {
                  ...
                  (new BukkitRunnable() {
                      public void run() {
                        for (Player onlinePlayer : world.getPlayers())
                          onlinePlayer.sendMessage(Variable.Lang_YML.getString("BiomeChangeComplete")); 
                        player.sendMessage(String.format(Variable.Lang_YML.getString("BiomeChangeSuccess"), new Object[] { biome.name() }));
                      }
                    }).runTask((Plugin)Main.JavaPlugin);
                }
              }).runTaskAsynchronously((Plugin)Main.JavaPlugin);
          ...
          player.sendMessage(Variable.Lang_YML.getString("NoPermissionCheck"));
          return false;
        } 
      } 
      return false;
    ...
    if (args.length == 1 && args[0].equalsIgnoreCase("update")) {
      ...
      if (Util.CheckOwnerAndManagerAndOP(p, p.getWorld().getName().replace(Variable.world_prefix, "")).booleanValue()) {
        File f = new File(Variable.Tempf, String.valueOf(String.valueOf(p.getWorld().getName().replace(Variable.world_prefix, ""))) + ".yml");
        if (Variable.bungee) {
          ...
          if (Now.intValue() >= Main.JavaPlugin.getConfig().getInt("MaxLevel")) {
            ...
            if (GetMoney >= ((Double)Main.JavaPlugin.getConfig().getDoubleList("MoneyNeed").get(Now.intValue() - 1)).doubleValue()) {
              if (Variable.PlyaerPointsModule) {
                ...
                if (GetPoints.intValue() < ((Integer)Main.JavaPlugin.getConfig().getIntegerList("PointsNeed").get(Now.intValue() - 1)).intValue()) {
                  String str = Variable.Lang_YML.getString("UpdateNoPoints");
                  if (str.contains("<NeedPoints>"))
                    str = str.replace("<NeedPoints>", String.valueOf(Main.JavaPlugin.getConfig().getIntegerList("PointsNeed").get(Now.intValue() - 1))); 
                  sender.sendMessage(Variable.Lang_YML.getString("HeadLineTtitle"));
              ...
              if (!((String)Main.JavaPlugin.getConfig().getStringList("ItemsNeed").get(Now.intValue() - 1)).equalsIgnoreCase("")) {
                String[] arrayOfString = ((String)Main.JavaPlugin.getConfig().getStringList("ItemsNeed").get(Now.intValue() - 1)).split(",");
              ...
              if (Variable.PlyaerPointsModule)
                Variable.playerPoints.getAPI().take(p.getUniqueId(), ((Integer)Main.JavaPlugin.getConfig().getIntegerList("PointsNeed").get(Now.intValue() - 1)).intValue()); 
              Variable.econ.withdrawPlayer((OfflinePlayer)p, ((Double)Main.JavaPlugin.getConfig().getDoubleList("MoneyNeed").get(Now.intValue() - 1)).doubleValue());
              ...
              if (temp.contains("<Level>"))
                temp = temp.replace("<Level>", String.valueOf(MySQL.getLevel(p.getWorld().getName().replace(Variable.world_prefix, "")))); 
              sender.sendMessage(temp);
              if (Main.JavaPlugin.getConfig().getBoolean("BorderSwitch")) {
                String serverType = Bukkit.getServer().getName();
                if ("arclight".equalsIgnoreCase(serverType)) {
                  World world = Bukkit.getWorld(String.valueOf(Variable.world_prefix) + p.getName());
                  world.getWorldBorder().setCenter(world.getSpawnLocation());
                  world.getWorldBorder().setSize(world.getWorldBorder().getSize() + Main.JavaPlugin.getConfig().getInt("UpdateRadius"));
                } else {
                  World playerWorld = p.getWorld();
                  playerWorld.getWorldBorder().setCenter(playerWorld.getSpawnLocation());
                  playerWorld.getWorldBorder().setSize(playerWorld.getWorldBorder().getSize() + Main.JavaPlugin.getConfig().getInt("UpdateRadius"));
                } 
              } 
            } else {
              String temp = Variable.Lang_YML.getString("UpdateNoEnoughMoney");
              if (temp.contains("<NeedMoney>"))
                temp = temp.replace("<NeedMoney>", String.valueOf(Main.JavaPlugin.getConfig().getDoubleList("MoneyNeed").get(Now.intValue() - 1))); 
              sender.sendMessage(Variable.Lang_YML.getString("HeadLineTtitle"));
              sender.sendMessage(temp);
              sender.sendMessage(Variable.Lang_YML.getString("BottomLineTtitle"));
            } 
    ...
    if (args.length == 1 && 
      ...
      if (!Util.CheckIsHome(p.getLocation().getWorld().getName().replace(Variable.world_prefix, ""))) {
        String str = Variable.Lang_YML.getString("NowIsNotHome");
        sender.sendMessage(Variable.Lang_YML.getString("HeadLineTtitle"));
        sender.sendMessage(str);
        sender.sendMessage(Variable.Lang_YML.getString("BottomLineTtitle"));
        return false;
      ...
      if (!p.getWorld().getName().replace(Variable.world_prefix, "").equalsIgnoreCase(p.getName())) {
        String str = Variable.Lang_YML.getString("DeleteNotIsMyHome");
        sender.sendMessage(Variable.Lang_YML.getString("HeadLineTtitle"));
        sender.sendMessage(str);
        sender.sendMessage(Variable.Lang_YML.getString("BottomLineTtitle"));
        return false;
      ...
      if (Variable.bungee) {
        ...
        File f2 = new File(Variable.Tempf, String.valueOf(String.valueOf(p.getName())) + ".yml");
        f2.delete();
      } 
      World world = Bukkit.getWorld(String.valueOf(Variable.world_prefix) + p.getName());
      if (world != null)
        for (Player p6 : Bukkit.getWorld(String.valueOf(Variable.world_prefix) + p.getName()).getPlayers()) {
          p6.teleport(Bukkit.getWorld("world").getSpawnLocation());
          p6.sendMessage(Variable.Lang_YML.getString("WorldHasBeenDeleted"));
        }  
      Bukkit.unloadWorld(String.valueOf(Variable.world_prefix) + p.getName(), true);
      if (Variable.hook_multiverseCore) {
        MultiverseCore mvcore = (MultiverseCore)Bukkit.getServer().getPluginManager().getPlugin("Multiverse-Core");
        MVWorldManager mv_m = mvcore.getMVWorldManager();
        mv_m.removeWorldFromConfig(String.valueOf(Variable.world_prefix) + p.getName());
      } 
      (new BukkitRunnable() {
          public void run() {
            if (Variable.world_prefix.equalsIgnoreCase("")) {
              if (Bukkit.getVersion().toString().toUpperCase().contains("ARCLIGHT") || Bukkit.getVersion().toString().contains("1.20.1")) {
                File f = new File(String.valueOf(Variable.single_server_gen) + Variable.world_prefix + p.getName());
                Util.deleteFile(f);
              } else {
                File f = new File(String.valueOf(Variable.single_server_gen) + "world" + Variable.file_loc_prefix + p.getName());
                Util.deleteFile(f);
              } 
            } else {
              File f = new File(String.valueOf(Variable.single_server_gen) + Variable.world_prefix + p.getName());
    ...
    if (args.length == 3 && 
      ...
      for (Home home : HomeAPI.getHomes()) {
        ...
        if (!Variable.Lang_YML.getString("GiftLoreAddPrefix").equalsIgnoreCase("")) {
          String lore = String.valueOf(String.valueOf(Variable.Lang_YML.getString("GiftLoreAddPrefix"))) + p.getName();
          if (i.hasItemMeta()) {
    ...
    if (args.length == 3 && 
      ...
      if (p.getName().equalsIgnoreCase(home_name)) {
        String str = Variable.Lang_YML.getString("SendButTheMyHome");
        sender.sendMessage(str);
        return false;
      } 
      ItemStack i = p.getItemInHand();
      ...
      if (Variable.bungee) {
        ...
        if (MySQL.alreadyhastheplayerjoin(p.getName())) {
          ...
          if (Main.JavaPlugin.getConfig().getBoolean("MoveWorldAfterUnLoad") && 
            Bukkit.getWorld(String.valueOf(Variable.world_prefix) + MySQL.getJoinHome(p.getName())) != null)
            has_been_load = true; 
        ...
        if (MySQL.alreadyhastheplayerhome(p.getName())) {
          ...
          boolean has_been_load = false;
          if (Main.JavaPlugin.getConfig().getBoolean("MoveWorldAfterUnLoad") && 
            Bukkit.getWorld(String.valueOf(Variable.world_prefix) + p.getName()) != null)
            has_been_load = true; 
          if (Main.JavaPlugin.getConfig().getBoolean("AutoMoveWorldFilesToOther") && !has_been_load && !Variable.wait_to_command.containsKey(p.getName()) && Main.JavaPlugin.getConfig().getBoolean("BungeeCord") && !Variable.has_already_move_world.contains(p.getName()) && amount == 0)
            if (Main.JavaPlugin.getConfig().getString("DecideBy").equalsIgnoreCase("Player")) {
        ...
        if (MySQL.alreadyhastheplayerjoin(p.getName())) {
          World world = Bukkit.getWorld(String.valueOf(Variable.world_prefix) + MySQL.getJoinHome(p.getName()));
          if (world == null) {
            WorldCreator creator = new WorldCreator(String.valueOf(Variable.world_prefix) + MySQL.getJoinHome(p.getName()));
            Variable.create_list_home.add(String.valueOf(Variable.world_prefix) + MySQL.getJoinHome(p.getName()));
            Bukkit.createWorld(creator);
          } 
          world = Bukkit.getWorld(String.valueOf(Variable.world_prefix) + MySQL.getJoinHome(p.getName()));
          Location loc = world.getSpawnLocation();
          ...
          World world = Bukkit.getWorld(String.valueOf(Variable.world_prefix) + p.getName());
          if (world == null) {
            WorldCreator creator = new WorldCreator(String.valueOf(Variable.world_prefix) + p.getName());
            Variable.create_list_home.add(String.valueOf(Variable.world_prefix) + p.getName());
            Bukkit.createWorld(creator);
          } 
          world = Bukkit.getWorld(String.valueOf(Variable.world_prefix) + p.getName());
          Location loc = world.getSpawnLocation();
          loc = Util.getNotAir(loc);
        ...
        if (f2.exists() || has_been_join) {
          if (!what_has_been_join.equalsIgnoreCase("")) {
            World world = Bukkit.getWorld(String.valueOf(Variable.world_prefix) + what_has_been_join);
            if (world == null) {
              WorldCreator creator = new WorldCreator(String.valueOf(Variable.world_prefix) + what_has_been_join);
              Variable.create_list_home.add(String.valueOf(Variable.world_prefix) + what_has_been_join);
              Bukkit.createWorld(creator);
            } 
            world = Bukkit.getWorld(String.valueOf(Variable.world_prefix) + what_has_been_join);
            Location loc = world.getSpawnLocation();
            loc = Util.getNotAir(loc);
            File tp_set = new File(Variable.Tempf, 
                String.valueOf(String.valueOf(world.getName().replace(Variable.world_prefix, ""))) + ".yml");
            ...
            Location loc = world.getSpawnLocation();
            loc = Util.getNotAir(loc);
            File tp_set = new File(Variable.Tempf, String.valueOf(String.valueOf(p.getName())) + ".yml");
            YamlConfiguration yamlConfiguration = YamlConfiguration.loadConfiguration(tp_set);
            loc.setX(yamlConfiguration.getDouble("X"));
            loc.setY(yamlConfiguration.getDouble("Y"));
            loc.setZ(yamlConfiguration.getDouble("Z"));
    ...
    if (args.length == 1) {
      if (args[0].equalsIgnoreCase("public")) {
        ...
        if (Variable.bungee) {
          ...
          File file = new File(Variable.Tempf, 
        ...
        File f2 = new File(Variable.Tempf, String.valueOf(String.valueOf(p.getWorld().getName().replace(Variable.world_prefix, ""))) + ".yml");
        if (Util.CheckOwnerAndManagerAndOP(p, p.getWorld().getName().replace(Variable.world_prefix, "")).booleanValue()) {
          if (Variable.bungee) {
            if (MySQL.getPublic(p.getWorld().getName().replace(Variable.world_prefix, "")).equals("true")) {
              ...
              for (Player pt : Bukkit.getOnlinePlayers()) {
                if (!Util.Check(pt, p.getWorld().getName().replace(Variable.world_prefix, "")).booleanValue() && 
      ...
      if (args[0].equalsIgnoreCase("tpset")) {
        if (Variable.bungee) {
          if (Util.CheckOwnerAndManagerAndOP(p, p.getWorld().getName().replace(Variable.world_prefix, "")).booleanValue()) {
            ...
            String str = Variable.Lang_YML.getString("TpSetSuccess");
            sender.sendMessage(Variable.Lang_YML.getString("HeadLineTtitle"));
            sender.sendMessage(str);
            sender.sendMessage(Variable.Lang_YML.getString("BottomLineTtitle"));
            return false;
          ...
          if (!p.getName().equalsIgnoreCase(p.getWorld().getName().replace(Variable.world_prefix, ""))) {
            ...
            if (Variable.flowers_list.containsKey(p.getName())) {
              ...
              if (has_give_amount >= set_flower) {
                String str = Variable.Lang_YML.getString("FlowersMax");
                if (str.contains("<Max>"))
      ...
      if (args[0].equalsIgnoreCase("MobSpawn")) {
        if (Util.CheckOwnerAndManagerAndOP(p, p.getWorld().getName().replace(Variable.world_prefix, "")).booleanValue()) {
          ...
          if (world.getGameRuleValue("doMobSpawning").equalsIgnoreCase("false")) {
            ...
            String str = Variable.Lang_YML.getString("EnableMobSpawn");
            sender.sendMessage(Variable.Lang_YML.getString("HeadLineTtitle"));
            sender.sendMessage(str);
            sender.sendMessage(Variable.Lang_YML.getString("BottomLineTtitle"));
            ...
            String str = Variable.Lang_YML.getString("DisableMobSpawn");
            sender.sendMessage(Variable.Lang_YML.getString("HeadLineTtitle"));
            sender.sendMessage(str);
            sender.sendMessage(Variable.Lang_YML.getString("BottomLineTtitle"));
          } 
    ...
    if (args.length == 2 && (
      ...
      if (Variable.bungee) {
        if (Util.CheckIsHome(args[1])) {
          ...
          boolean has_been_load = false;
          if (Main.JavaPlugin.getConfig().getBoolean("MoveWorldAfterUnLoad") && 
            Bukkit.getWorld(String.valueOf(Variable.world_prefix) + args[1]) != null)
            has_been_load = true; 
          if (Main.JavaPlugin.getConfig().getBoolean("AutoMoveWorldFilesToOther") && !has_been_load && !Variable.wait_to_command.containsKey(p.getName()) && Main.JavaPlugin.getConfig().getBoolean("BungeeCord") && !Variable.has_already_move_world.contains(p.getName()) && amount == 0)
            if (Main.JavaPlugin.getConfig().getString("DecideBy").equalsIgnoreCase("Player")) {
          ...
          if (MySQL.getServer(args[1]).equalsIgnoreCase(Main.JavaPlugin.getConfig().getString("Server"))) {
            World world = Bukkit.getWorld(String.valueOf(Variable.world_prefix) + args[1]);
            WorldCreator creator = new WorldCreator(String.valueOf(Variable.world_prefix) + args[1]);
            Variable.create_list_home.add(String.valueOf(Variable.world_prefix) + args[1]);
            Bukkit.createWorld(creator);
            world = Bukkit.getWorld(String.valueOf(Variable.world_prefix) + args[1]);
            Location loc = world.getSpawnLocation();
            loc = Util.getNotAir(loc);
        ...
        File f = new File(Variable.Tempf, String.valueOf(String.valueOf(args[1])) + ".yml");
        if (f.exists()) {
          YamlConfiguration yamlConfiguration = YamlConfiguration.loadConfiguration(f);
          World world = Bukkit.getWorld(String.valueOf(Variable.world_prefix) + args[1]);
          WorldCreator creator = new WorldCreator(String.valueOf(Variable.world_prefix) + args[1]);
      ...
      if (Variable.bungee) {
        ...
        if (!CheckSame.booleanValue()) {
          if (MySQL.alreadyhastheplayerhome(args[1])) {
            String str = Variable.Lang_YML.getString("InvitePlayerWhoHasCreateHome");
            sender.sendMessage(Variable.Lang_YML.getString("HeadLineTtitle"));
            sender.sendMessage(str);
            sender.sendMessage(Variable.Lang_YML.getString("BottomLineTtitle"));
            return false;
          ...
          if (MySQL.alreadyhastheplayerjoin(args[1])) {
            String str = Variable.Lang_YML.getString("InvitePlayerWhoHasJoinOthers");
            sender.sendMessage(Variable.Lang_YML.getString("HeadLineTtitle"));
            sender.sendMessage(str);
            sender.sendMessage(Variable.Lang_YML.getString("BottomLineTtitle"));
            return false;
          ...
          if (Variable.invite_list.containsKey(p.getName())) {
            String str = Variable.Lang_YML.getString("HasInInviteCooldown");
            sender.sendMessage(Variable.Lang_YML.getString("HeadLineTtitle"));
            sender.sendMessage(str);
            sender.sendMessage(Variable.Lang_YML.getString("BottomLineTtitle"));
            return false;
          ...
          if (Variable.invite_list.containsValue(args[1])) {
            String str = Variable.Lang_YML.getString("InvitePlayerWhoHasBeenAlreadyInvited");
            sender.sendMessage(Variable.Lang_YML.getString("HeadLineTtitle"));
            sender.sendMessage(str);
            sender.sendMessage(Variable.Lang_YML.getString("BottomLineTtitle"));
            return false;
          ...
          if (OP_List.size() + 2 > Main.JavaPlugin.getConfig().getInt("MaxOP")) {
            ...
            for (int m = Main.JavaPlugin.getConfig().getInt("MaxOP") * 3; m > Main.JavaPlugin
            ...
            if (OP_List.size() + 2 > max_player) {
              String str = Variable.Lang_YML.getString("ReachMaxOP");
              ...
              if (player == null) {
                String str1 = Variable.Lang_YML.getString("NoPlayerExist");
                sender.sendMessage(Variable.Lang_YML.getString("HeadLineTtitle"));
              ...
              invite_guoqi(p);
              String str = Variable.Lang_YML.getString("SendInviteToPlayer");
              if (str.contains("<Name>"))
          ...
          if (be_invite == null) {
            String str = Variable.Lang_YML.getString("NoPlayerExist");
            sender.sendMessage(Variable.Lang_YML.getString("HeadLineTtitle"));
            sender.sendMessage(str);
            sender.sendMessage(Variable.Lang_YML.getString("BottomLineTtitle"));
            return false;
        ...
        if (f2.exists()) {
          ...
          if (!CheckSame.booleanValue()) {
            File be_invite_file = new File(Variable.Tempf, String.valueOf(String.valueOf(args[1])) + ".yml");
            ...
            for (int m = (arrayOfFile = folder.listFiles()).length, b = 0; b < m; ) {
              ...
              String want_to = file.getPath().replace(Variable.Tempf, "").replace(".yml", "")
                .replace(Variable.file_loc_prefix, "");
            ...
            if (OP_List.size() + 2 > Main.JavaPlugin.getConfig().getInt("MaxOP")) {
              int max_player = Main.JavaPlugin.getConfig().getInt("MaxOP");
              for (int n = Main.JavaPlugin.getConfig().getInt("MaxOP") * 3; n > Main.JavaPlugin
    ...
    if (args.length == 1 && 
      ...
      if (Variable.bungee) {
        ...
        File f2 = new File(Variable.Tempf, String.valueOf(String.valueOf(who_invite)) + ".yml");
        if (!f2.exists()) {
          String temp = Variable.Lang_YML.getString("InviteAcceptNoExistHome");
          sender.sendMessage(Variable.Lang_YML.getString("HeadLineTtitle"));
          sender.sendMessage(temp);
        ...
        if (Variable.bungee) {
          ...
          if (!CheckSame.booleanValue()) {
            if (save.size() + 1 > Main.JavaPlugin.getConfig().getInt("MaxJoin")) {
              ...
              for (int k = Main.JavaPlugin.getConfig().getInt("MaxJoin") * 3; k > Main.JavaPlugin
              ...
              if (save.size() + 2 > max_player) {
                String str = Variable.Lang_YML.getString("MaxJoinMembers");
                if (str.contains("<MaxAmount>"))
                  str = str.replace("<MaxAmount>", String.valueOf(max_player)); 
                sender.sendMessage(Variable.Lang_YML.getString("HeadLineTtitle"));
                sender.sendMessage(str);
                ...
                String str1 = MySQL.getListStringSpiltByDot(MySQL.getMembers(p.getWorld().getName().replace(Variable.world_prefix, "")));
                if (str1 == null || str1.equalsIgnoreCase("")) {
                  str1 = Name;
                } else {
                  str1 = String.valueOf(String.valueOf(str1)) + "," + Name;
                } 
                MySQL.setMembers(p.getWorld().getName().replace(Variable.world_prefix, ""), str1);
                String str2 = Variable.Lang_YML.getString("AddTrustSuccess");
          ...
          if (!CheckSame.booleanValue()) {
            if (save.size() + 2 > Main.JavaPlugin.getConfig().getInt("MaxJoin")) {
              ...
              if (save.size() + 2 > max_player) {
                ...
                String str = Variable.Lang_YML.getString("AddTrustSuccess");
                if (str.contains("<Name>"))
      ...
      if (Util.CheckOwnerAndManagerAndOP(p, p.getWorld().getName().replace(Variable.world_prefix, "")).booleanValue()) {
        ...
        if (Variable.bungee) {
          ...
          if (!CheckSame.booleanValue()) {
            ...
            for (Player pt : Bukkit.getWorld(String.valueOf(Variable.world_prefix) + p.getName()).getPlayers()) {
              if (pt.getName().equalsIgnoreCase(Name)) {
                String str1 = Variable.Lang_YML.getString("BeKicked");
    ...
    if (args.length == 1 && (
      ...
      if (Variable.bungee) {
        ...
        if (!bool) {
          String str = Variable.Lang_YML.getString("QuitButNoJoin");
          p.sendMessage(str);
          return false;
        } 
      ...
      int b, j;
      File[] arrayOfFile;
      label3550: for (j = (arrayOfFile = folder.listFiles()).length, b = 0; b < j; ) {
        File temp = arrayOfFile[b];
        String want_to = temp.getPath().replace(Variable.Tempf, "").replace(".yml", "")
          .replace(Variable.file_loc_prefix, "");
        YamlConfiguration yamlConfiguration = YamlConfiguration.loadConfiguration(temp);
    ...
    if (args.length == 2 && 
      ...
      if (Main.JavaPlugin.getConfig().getBoolean("BungeeCord")) {
        ...
        File f2 = new File(Variable.Tempf, String.valueOf(String.valueOf(p.getName().replace(Variable.world_prefix, ""))) + ".yml");
        if (f2.exists()) {
          sender.sendMessage(Variable.Lang_YML.getString("HeadLineTtitle"));
      ...
      if (v.equalsIgnoreCase("1")) {
        WorldCreator creator = null;
        creator = new WorldCreator(String.valueOf(Variable.world_prefix) + p.getName());
        ...
        String newDir = String.valueOf(String.valueOf(newf.getPath().toString())) + Variable.file_loc_prefix + p.getName();
        File exist_file = new File(oldDir);
        if (!exist_file.exists()) {
          String temp = Variable.Lang_YML.getString("WorldFileNotExist");
          if (temp.contains("<name>"))
      ...
      if (Variable.hook_multiverseCore) {
        ...
        MultiverseCore mvcore = (MultiverseCore)Bukkit.getServer().getPluginManager().getPlugin("Multiverse-Core");
        MVWorldManager mv_m = mvcore.getMVWorldManager();
        if (mv_m.isMVWorld(String.valueOf(Variable.world_prefix) + p.getName()))
          mv_m.removeWorldFromConfig(String.valueOf(Variable.world_prefix) + p.getName()); 
        if (v.equalsIgnoreCase("1")) {
          mv_m.addWorld(String.valueOf(Variable.world_prefix) + p.getName(), World.Environment.NORMAL, seed, WorldType.NORMAL, Boolean.valueOf(Main.JavaPlugin.getConfig().getBoolean("generateStructures")), "");
        } else if (v.equalsIgnoreCase("2")) {
          mv_m.addWorld(String.valueOf(Variable.world_prefix) + p.getName(), World.Environment.NORMAL, seed, WorldType.FLAT, Boolean.valueOf(Main.JavaPlugin.getConfig().getBoolean("generateStructures")), "");
        } else {
          mv_m.addWorld(String.valueOf(Variable.world_prefix) + p.getName(), World.Environment.NORMAL, seed, WorldType.NORMAL, Boolean.valueOf(Main.JavaPlugin.getConfig().getBoolean("generateStructures")), "");
        } 
        if (Main.JavaPlugin.getConfig().getBoolean("EnableChatPrefix")) {
          MultiverseWorld multiverseWorld = mv_m.getMVWorld(String.valueOf(Variable.world_prefix) + p.getName());
          World world1 = Bukkit.getWorld(String.valueOf(Variable.world_prefix) + p.getName());
          String temp = Variable.Lang_YML.getString("PlaceHolders.WorldName");
          if (temp.contains("<PlayerName>"))
            temp = temp.replace("<PlayerName>", 
                world1.getName().replace(Variable.world_prefix, "")); 
        ...
        MultiverseWorld mv = mv_m.getMVWorld(String.valueOf(Variable.world_prefix) + p.getName());
        mv.setAutoLoad(false);
      } 
      World world = Bukkit.getWorld(String.valueOf(Variable.world_prefix) + p.getName());
