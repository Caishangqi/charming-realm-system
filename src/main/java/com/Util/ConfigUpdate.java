  ...
  public static void update() {
    ...
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 1.97D) {
      ...
      if (Variable.Lang_YML.getString("AdminSetLevelSuccess") == null) {
        Variable.Lang_YML.set("AdminSetLevelSuccess", "§7[CharmRealm] §c成功设置该领域的等级!");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("ClearInventoryBeforeCreate") == null) {
        Variable.Lang_YML.set("ClearInventoryBeforeCreate", "§7[CharmRealm] §d创建领域时背包已清空完毕!");
        lang_check = true;
      } 
      config_check = true;
    } 
    ...
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 1.99D) {
      ...
      if (Variable.Lang_YML.getString("UpdateLanguageMessage") == null) {
        Variable.Lang_YML.set("UpdateLanguageMessage", "§7[CharmRealm] §a配置文件Language.yml已自动更");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("UpdateGuiMessage") == null) {
        Variable.Lang_YML.set("UpdateGuiMessage", "§7[CharmRealm] §a配置文件Gui.yml已自动更");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("UpdateConfigMessage") == null) {
        Variable.Lang_YML.set("UpdateConfigMessage", "§7[CharmRealm] §a配置文件Config.yml已自动更");
        lang_check = true;
      } 
      config_check = true;
    } 
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 1.992D) {
      ...
      if (Variable.Lang_YML.getString("DisableFunctionButTeleport") == null) {
        Variable.Lang_YML.set("DisableFunctionButTeleport", "§7[CharmRealm] §d已为您关闭除了GUI和传送指令以外其他所有功");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("DisableFunctionTip") == null) {
        Variable.Lang_YML.set("DisableFunctionTip", "§7[CharmRealm] §d本插件除了传送以外的其他功能已被服主关闭,请前领域服务器使用该命令");
        lang_check = true;
      } 
      config_check = true;
    } 
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 1.993D) {
      if (Variable.Lang_YML.getString("EnableMobSpawn") == null) {
        Variable.Lang_YML.set("EnableMobSpawn", "§7[CharmRealm] §d成功启领域的刷�功");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("DisableMobSpawn") == null) {
        Variable.Lang_YML.set("DisableMobSpawn", "§7[CharmRealm] §d成功关闭领域的刷怪功");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("AutoUpdateHomeLevel") == null) {
        Variable.Lang_YML.set("AutoUpdateHomeLevel", "§7[CharmRealm] §d测到您有更高级别的领域等级权,为您自动提升领域等级!");
        lang_check = true;
      } 
      config_check = true;
    } 
    ...
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 1.996D) {
      if (Variable.Lang_YML.getString("DifficultyModify") == null) {
        Variable.Lang_YML.set("DifficultyModify", "§7[CharmRealm] §d为您当前领域调整<Mode>模式!");
        lang_check = true;
      } 
      config_check = true;
    } 
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 1.997D) {
      ...
      if (Variable.Lang_YML.getString("StartLowestLagServer") == null) {
        Variable.Lang_YML.set("StartLowestLagServer", "§7[CharmRealm] §d正在为您进行均衡负载模式进行创建领域,请等待~");
        lang_check = true;
      } 
      config_check = true;
    } 
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 1.998D) {
      if (Variable.Lang_YML.getString("WorldIsNotExist") == null) {
        Variable.Lang_YML.set("WorldIsNotExist", "§7[CharmRealm] §d世界不存,请检查世界存档是否存放在地图目录/本插件地图目录下~");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("WorldTeleport") == null) {
        Variable.Lang_YML.set("WorldTeleport", "§7[CharmRealm] §d世界传�成功~");
        lang_check = true;
      } 
      config_check = true;
    } 
    ...
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 2.0D) {
      if (Variable.Lang_YML.getString("ProtectFarm") == null) {
        Variable.Lang_YML.set("ProtectFarm", "§7[CharmRealm] §d当前耕地被保护着,您没有权,请勿践踏!");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("ProtectEntity") == null) {
        Variable.Lang_YML.set("ProtectEntity", "§7[CharmRealm] §d当前实体被保护着,您没有权,请勿触碰!");
        lang_check = true;
      } 
      config_check = true;
    } 
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 2.001D) {
      if (Variable.Lang_YML.getString("SoilTypeError") == null) {
        Variable.Lang_YML.set("SoilTypeError", "§7[CharmRealm] §dConfig.yml配置的�地类型SoilType错误,类型可以选择:SOIL/FARMLAND,1.16.5-Cat端使用FARMLAND");
        lang_check = true;
      } 
    ...
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 2.002D) {
      if (Variable.Lang_YML.getString("PlaceInMaxHeight") == null) {
        Variable.Lang_YML.set("PlaceInMaxHeight", "§7[CharmRealm] §d抱歉,当前您放置的方块超过了领域高度上,请勿高处放置方块");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("EnableHeightLimit") == null) {
        Variable.Lang_YML.set("EnableHeightLimit", "§7[CharmRealm] §a您开启了领域放置高高度的监听");
        lang_check = true;
      } 
    ...
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 2.005D) {
      ...
      if (Variable.Lang_YML.getString("ClearExtraBlocks") == null) {
        Variable.Lang_YML.set("ClearExtraBlocks", "§7[CharmRealm] §c测到区块/世界放置方块过多,为您自动清空掉~");
        lang_check = true;
      } 
      config_check = true;
    } 
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 2.006D) {
      ...
      if (Variable.Lang_YML.getString("UpdateNoPoints") == null) {
        Variable.Lang_YML.set("UpdateNoPoints", "§7[CharmRealm] §c点券不足<NeedPoints>");
        lang_check = true;
      } 
    } 
    ...
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 2.009D) {
      ...
      if (Variable.Lang_YML.getString("TakeBlackItemsInNoPermissionHome") == null) {
        Variable.Lang_YML.set("TakeBlackItemsInNoPermissionHome", "§7[CharmRealm] §c抱歉,禁止携带违禁品进入无权限的家,关键:<type>");
        lang_check = true;
      } 
    } 
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 2.012D) {
      ...
      if (Variable.Lang_YML.getString("PopularityAdd") == null) {
        Variable.Lang_YML.set("PopularityAdd", "§7[CharmRealm] §d您为<Name>的领域增加了1点人");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("PopularityAddToOwnerAndOP") == null) {
        Variable.Lang_YML.set("PopularityAddToOwnerAndOP", "§7[CharmRealm] §d您的领域<Player>访问,增加1点人");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("FlowersAdd") == null) {
        Variable.Lang_YML.set("FlowersAdd", "§7[CharmRealm] §d您为<Name>的领域�上了一束鲜,<Now>/<Max>");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("FlowersAddToOwnerAndOP") == null) {
        Variable.Lang_YML.set("FlowersAddToOwnerAndOP", "§7[CharmRealm] §d您的领域<Player>投�了束鲜");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("FlowersMax") == null) {
        Variable.Lang_YML.set("FlowersMax", "§7[CharmRealm] §d今日鲜花已经用完,<Max>/<Max>");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("FlowersMySelf") == null) {
        Variable.Lang_YML.set("FlowersMySelf", "§7[CharmRealm] §d抱歉,鲜花无法赠�给自己拥有权限的家");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("GiftAdd") == null) {
        Variable.Lang_YML.set("GiftAdd", "§7[CharmRealm] §d领域的礼物盒<Name>赠�了物品,快去看看,点我打开~");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("GiftSuccess") == null) {
        Variable.Lang_YML.set("GiftSuccess", "§7[CharmRealm] §d您赠送了手上的物品给<Name>,感谢馈赠~");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("GiftFail") == null) {
        Variable.Lang_YML.set("GiftFail", "§7[CharmRealm] §d该领域的礼物盒已,无法赠�~");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("NoPermissionOpenGift") == null) {
        Variable.Lang_YML.set("NoPermissionOpenGift", "§7[CharmRealm] §d缺乏权限:SelfHome.Gift.Open,无法打开礼物盒~");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("NoPermissionOpenOthersGift") == null) {
        Variable.Lang_YML.set("NoPermissionOpenOthersGift", "§7[CharmRealm] §d您没有权限打他人领域的礼物盒~");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("NoPermissionSendTheItemToGift") == null) {
        Variable.Lang_YML.set("NoPermissionSendTheItemToGift", "§7[CharmRealm] §d缺乏权限:SelfHome.Gift.Send,无法打开礼物盒~");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("HasAlreadyOpenByOthers") == null) {
        Variable.Lang_YML.set("HasAlreadyOpenByOthers", "§7[CharmRealm] §d礼物盒正在被玩家<Name>打开,目前无法查看~");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("SendButTheHandIsAir") == null) {
        Variable.Lang_YML.set("SendButTheHandIsAir", "§7[CharmRealm] §d抱歉,当前您手上的物品为空,无法发�过去哦~");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("SendButTheInvHasBeenOpen") == null) {
        Variable.Lang_YML.set("SendButTheInvHasBeenOpen", "§7[CharmRealm] §d抱歉,该领域的礼物盒已被打,请等待该玩家关闭后再发?");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("SendButTheMyHome") == null) {
        Variable.Lang_YML.set("SendButTheMyHome", "§7[CharmRealm] §d抱歉,您不能给自己送礼物哦~");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("InvPlayersGiftGuiButNoPermission") == null) {
        Variable.Lang_YML.set("InvPlayersGiftGuiButNoPermission", "§7[CharmRealm] §d抱歉,您没有权限打别人的领域收件箱,缺乏权限:SelfHome.Open.Inv");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("GiftGuiTitle") == null) {
        Variable.Lang_YML.set("GiftGuiTitle", "§8领域礼物");
        lang_check = true;
      } 
      ...
      if (Variable.Lang_YML.getString("NotHookProtocolLib") == null) {
        Variable.Lang_YML.set("NotHookProtocolLib", "§7[CharmRealm] §a没有发现Vault，领域礼物盒相关功能无法正常使用");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("HookProtocolLib") == null) {
        Variable.Lang_YML.set("HookProtocolLib", "§7[CharmRealm] §a挂载:ProtocolLib 领域礼物盒相关功能可正常使用");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("TodayRefreshPopularityAndFlowerData") == null) {
        Variable.Lang_YML.set("TodayRefreshPopularityAndFlowerData", "§7[CharmRealm] §a今日的玩 - 鲜花和人 - 数据已自动刷新重");
        lang_check = true;
      } 
    } 
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 2.013D) {
      ...
      if (Variable.Lang_YML.getString("NoPermissionSetIcon") == null) {
        Variable.Lang_YML.set("NoPermissionSetIcon", "§7[CharmRealm] §d缺乏权限:SelfHome.ICON,无法设置图标~");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("NoPermissionSetOthersIcon") == null) {
        Variable.Lang_YML.set("NoPermissionSetOthersIcon", "§7[CharmRealm] §c没有权限设置他人领域的传送ICON图标");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("SetIconButHandIsAir") == null) {
        Variable.Lang_YML.set("SetIconButHandIsAir", "§7[CharmRealm] §c抱歉,您不能设置ICON图标为手上的空气~");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("SetIconSuccess") == null) {
        Variable.Lang_YML.set("SetIconSuccess", "§7[CharmRealm] §a设置成功!");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("NoPermissionSetInfo") == null) {
        Variable.Lang_YML.set("NoPermissionSetInfo", "§7[CharmRealm] §d缺乏权限:SelfHome.Info,无法设置领域标语~");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("NoPermissionSetColorInfo") == null) {
        Variable.Lang_YML.set("NoPermissionSetColorInfo", "§7[CharmRealm] §d缺乏权限:SelfHome.Info.Color,无法设置带颜色的标语~");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("NoPermissionSetOthersInfo") == null) {
        Variable.Lang_YML.set("NoPermissionSetOthersInfo", "§7[CharmRealm] §c没有权限设置他人领域的领域标语~");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("SetInfoSuccess") == null) {
        Variable.Lang_YML.set("SetInfoSuccess", "§7[CharmRealm] §a设置成功!换行符为逗号,");
        lang_check = true;
      } 
    ...
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 2.014D)
      if (Variable.Lang_YML.getString("WantToPutItemIntoGiftChest") == null) {
        Variable.Lang_YML.set("WantToPutItemIntoGiftChest", "§7[CharmRealm] §d抱歉,礼物盒仓库并不是给你存放你的物品的哦~");
        lang_check = true;
      }  
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 2.017D) {
      if (Variable.Lang_YML.getString("OperatorSendGiftButOpen") == null) {
        Variable.Lang_YML.set("OperatorSendGiftButOpen", "§7[CharmRealm] §d抱歉,管理员正在派发福利礼包到您的收件,已为您自动关闭界,请重新打~");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("SuccessedSendToAll") == null) {
        Variable.Lang_YML.set("SuccessedSendToAll", "§7[CharmRealm] §d您已经成功发送手上的物品到礼物盒的领域列:<List>");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("FailedSendToAll") == null) {
        Variable.Lang_YML.set("FailedSendToAll", "§7[CharmRealm] §d以下领域列表发�失,礼物盒已:<List>");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("PopularityAddButHomeIsNotExist") == null) {
        Variable.Lang_YML.set("PopularityAddButHomeIsNotExist", "§7[CharmRealm] §d人气设置失败,该领域不存在");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("FlowerAddButHomeIsNotExist") == null) {
        Variable.Lang_YML.set("FlowerAddButHomeIsNotExist", "§7[CharmRealm] §d鲜花设置失败,该领域不存在");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("PopularityAddSuccess") == null) {
        Variable.Lang_YML.set("PopularityAddSuccess", "§7[CharmRealm] §d人气设置成功,目前的人气�为<Now>");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("FlowerAddSuccess") == null) {
        Variable.Lang_YML.set("FlowerAddSuccess", "§7[CharmRealm] §d鲜花设置成功,目前的鲜花�为<Now>");
        lang_check = true;
      } 
    } 
    ...
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 2.019D && 
      ...
      Variable.Lang_YML.set("DisableAutoSaveWorld", "§7[CharmRealm] §a领域的自动保存功 已关");
      lang_check = true;
    } 
    ...
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 2.023D) {
      ...
      if (Variable.Lang_YML.getString("PlayerMoveOverBorderButAdventure") == null) {
        Variable.Lang_YML.set("PlayerMoveOverBorderButAdventure", "§8[§6CharmRealms§8] §7测到您走出边界过,自动切换为冒险模.");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("OutdatedWorldHasBeenDeleted") == null) {
        Variable.Lang_YML.set("OutdatedWorldHasBeenDeleted", "§8[§6CharmRealms§8] §7本次清空领域<Amount>,清空的列:<List>");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("OutdateWorldConfirm") == null) {
        Variable.Lang_YML.set("OutdateWorldConfirm", "§8[§6CharmRealms§8] §7您确定要删除<Day>天未被他人或自己访问过的有符合条件的领域?,5秒冷,请再次输>>>");
        lang_check = true;
      } 
    } 
    ...
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 2.026D) {
      if (Variable.Lang_YML.getString("NoPermissionSetCustomBlockLimit") == null) {
        Variable.Lang_YML.set("NoPermissionSetCustomBlockLimit", "§8[§6CharmRealms§8] §7抱歉,您无权设置方块的自定义放置功能指令,非OP身份~");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("SetCustomBlockButHomeIsNull") == null) {
        Variable.Lang_YML.set("SetCustomBlockButHomeIsNull", "§8[§6CharmRealms§8] §7抱歉,参数里的领域不存在~");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("SetCustomBlockButHomeButHasAlreadyContain") == null) {
        Variable.Lang_YML.set("SetCustomBlockButHomeButHasAlreadyContain", "§8[§6CharmRealms§8] §7抱歉,该领域的该限制已存在~");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("SetCustomBlockButHomeButNotContain") == null) {
        Variable.Lang_YML.set("SetCustomBlockButHomeButNotContain", "§8[§6CharmRealms§8] §7抱歉,该领域的该限制不存在~");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("SetCustomBlockSuccess") == null) {
        Variable.Lang_YML.set("SetCustomBlockSuccess", "§8[§6CharmRealms§8] §7成功设置<Name>领域的<NBT>方块放置数量为:<Amount>,限制类型为:<Type>");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("RemoveCustomBlockSuccess") == null) {
        Variable.Lang_YML.set("RemoveCustomBlockSuccess", "§8[§6CharmRealms§8] §7成功移除<Name>领域的<NBT>方块放置的限制,限制类型为:<Type>");
        lang_check = true;
      } 
      if (Variable.Lang_YML.getString("AddCustomBlockSuccess") == null) {
        Variable.Lang_YML.set("AddCustomBlockSuccess", "§8[§6CharmRealms§8] §7成功添加<Name>领域的<NBT>方块放置数量<Amount>个,目前新的限制数量为:<NowAmount>,限制类型为:<Type>");
        lang_check = true;
      } 
      config_check = true;
    } 
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 2.027D) {
      ...
      if (Variable.Lang_YML.getString("MultiverseCoreCompability") == null) {
        Variable.Lang_YML.set("MultiverseCoreCompability", "§8[§6CharmRealms§8] §a挂载到:Multiverse-Core 兼容多世界插件已开启~");
        lang_check = true;
      } 
      ...
      if (!Variable.Lang_YML.isConfigurationSection("NowIsTheLatestPlugin")) {
        Variable.Lang_YML.set("NowIsTheLatestPlugin", "§8[§6CharmRealms§8] §d当前运行的插件版本为最新版:§a<Now>");
        lang_check = true;
      } 
      if (!Variable.Lang_YML.isConfigurationSection("CheckUpdateFailed")) {
        Variable.Lang_YML.set("CheckUpdateFailed", "§8[§6CharmRealms§8] §c版本更新检查失败!");
        lang_check = true;
      } 
    ...
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 2.0283D) {
      ...
      if (!Variable.Lang_YML.isConfigurationSection("FaweAndWorldEditCompability")) {
        Variable.Lang_YML.set("FaweAndWorldEditCompability", "§8[§6CharmRealms§8] §a挂载到:Multiverse-FastAsyncWorldEdit 异步形状边界功能已开启~");
        lang_check = true;
      } 
      if (!Variable.Lang_YML.isConfigurationSection("ToggleccWorldEnable")) {
        Variable.Lang_YML.set("ToggleccWorldEnable", "§8[§6CharmRealms§8] §a成功切换边界显示情况为: 显示");
        lang_check = true;
      } 
      if (!Variable.Lang_YML.isConfigurationSection("ToggleccWorldDisable")) {
        Variable.Lang_YML.set("ToggleccWorldDisable", "§8[§6CharmRealms§8] §a成功切换边界显示情况为: 隐藏");
        lang_check = true;
      } 
      config_check = true;
    } 
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 2.0285D) {
      if (!Variable.Lang_YML.isConfigurationSection("BiomeChangeTip")) {
        Variable.Lang_YML.set("BiomeChangeTip", "§8[§6CharmRealms§8] §a已为您更改当前的区块群系,请重新上线查看生效!");
        lang_check = true;
      } 
      config_check = true;
    } 
    if (Main.JavaPlugin.getConfig().getDouble("Version") < 2.0296D) {
      if (!Variable.Lang_YML.isConfigurationSection("WeatherRain")) {
        Variable.Lang_YML.set("WeatherRain", "§8[§6CharmRealms§8] §a为您切换为雨天");
        lang_check = true;
      } 
      if (!Variable.Lang_YML.isConfigurationSection("WeatherSun")) {
        Variable.Lang_YML.set("WeatherSun", "§8[§6CharmRealms§8] §a为您切换为晴天");
        lang_check = true;
      } 
      if (!Variable.Lang_YML.isConfigurationSection("TimeDay")) {
        Variable.Lang_YML.set("TimeDay", "§8[§6CharmRealms§8] §a为您切换为白天");
        lang_check = true;
      } 
      if (!Variable.Lang_YML.isConfigurationSection("TimeNight")) {
        Variable.Lang_YML.set("TimeNight", "§8[§6CharmRealms§8] §a为您切换为黑天");
        lang_check = true;
      } 
      if (!Variable.Lang_YML.isConfigurationSection("LookSeed")) {
        Variable.Lang_YML.set("LookSeed", "§8[§6CharmRealms§8] §a当前世界的种子为:<Seed>");
        lang_check = true;
      } 
      if (!Variable.Lang_YML.isConfigurationSection("BiomeError")) {
        Variable.Lang_YML.set("BiomeError", "§8[§6CharmRealms§8] §a群系类型错误,请检查");
        lang_check = true;
      } 
      if (!Variable.Lang_YML.isConfigurationSection("EnableFly")) {
        Variable.Lang_YML.set("EnableFly", "§8[§6CharmRealms§8] §a成功为您开启飞行模式");
        lang_check = true;
      } 
      if (!Variable.Lang_YML.isConfigurationSection("DisableFly")) {
        Variable.Lang_YML.set("DisableFly", "§8[§6CharmRealms§8] §a成功为您关闭飞行模式");
        lang_check = true;
      } 
      if (!Variable.Lang_YML.isConfigurationSection("ToggleccWorldDisableFlying")) {
        Variable.Lang_YML.set("ToggleccWorldDisableFlying", "§8[§6CharmRealms§8] §a您离开了飞行的世界,为您自动关闭飞行功能.");
        lang_check = true;
      } 
      config_check = true;
    } 
